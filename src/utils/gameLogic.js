...
const LEVEL_TABLE = [
  ...
  { digits:2, count:7, ms:1400, label:'2けた 7こ', world:2 }, // Lv36
  { digits:2, count:7, ms:1300, label:'2けた 7こ', world:2 }, // Lv37
  { digits:2, count:7, ms:1100, label:'2けた 7こ', world:2 }, // Lv38
  { digits:2, count:8, ms:1250, label:'2けた 8こ', world:2 }, // Lv39
  { digits:2, count:8, ms:1100, label:'2けた 8こ', world:2 }, // Lv40
  { digits:2, count:9, ms:1000, label:'2けた 9こ', world:2 }, // Lv41
  { digits:2, count:10, ms:1200, label:'2けた 10こ', world:2 }, // Lv42
  { digits:2, count:10, ms:1100, label:'2けた 10こ', world:2 }, // Lv43
  { digits:2, count:10, ms:1000, label:'2けた 10こ', world:2 }, // Lv44 ← GOAL
  // 3桁
...
export const COINS_PER_CORRECT = 100;
export const MAX_COINS_PER_PLAY = 800;
